...
public class RoundImageView extends AppCompatImageView {
    ...
    public RoundImageView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mBorderColor = a.getColor(R.styleable.RoundImageView_borderColor, Color.WHITE);
        mBorderWidth = a.getDimension(R.styleable.RoundImageView_borderWidth, 0);
        mCornerRadius = a.getDimension(R.styleable.RoundImageView_cornerRadius, dp2px(10));
