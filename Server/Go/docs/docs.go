            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.JumpUrlRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "ok",
                        "schema": {
                            "$ref": "#/definitions/models.JumpUrlResponse"
                        }
                    },
                    "400": {
                        "description": "4xx, 客户端错误",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.AuthTokenRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "models.PlayInfo": {
            ...
            "properties": {
                ...
                "definition": {
                    "description": "视频流清晰度定义。取值： FD：流畅。 LD：标清。 SD：高清。 HD：超清 OD：原画。 2K：2K。 4K：4K。 SQ：普通音质。 HQ：高音质。 AUTO：自适应码率。",
                    "type": "string"
                },
                "duration": {
