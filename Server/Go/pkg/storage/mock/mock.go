...
var _ storage.StorageAPI = (*MockDb)(nil)
...
func (m *MockDb) UpdateRoomStatus(id string, r *models.RoomInfo) error {
	jsonBytes, err := json.Marshal(r)
	if err != nil {
		return err
	}
...
func (m *MockDb) GetRoomByMeetingId(meetingId string) (*models.RoomInfo, error) {
