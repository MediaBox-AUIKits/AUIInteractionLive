 ...
 * @version 2021/9/27
 */
public class EnterpriseFlyView extends LimitSizeRecyclerView {

    private static final String TAG = EnterpriseFlyView.class.getSimpleName();
    ...
    public EnterpriseFlyView(@NonNull Context context) {
        this(context, null, 0);
    }

    public EnterpriseFlyView(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public EnterpriseFlyView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        setMaxHeight(getResources().getDimensionPixelOffset(com.aliyun.auibarrage.R.dimen.live_message_fly_height));
        recyclerViewHelper = RecyclerViewHelper.of(this, com.aliyun.auibarrage.R.layout.ilr_view_fly_item,
                new RecyclerViewHelper.HolderRenderer<FlyItem>() {
                    @Override
                    public void render(RecyclerViewHelper<FlyItem> viewHelper, RecyclerViewHelper.ViewHolder holder, FlyItem model, int position, int itemCount, List<Object> payloads) {
                        TextView itemView = holder.getView(com.aliyun.auibarrage.R.id.item_content);
        ...
        EnterpriseCustomItemAnimator animator = new EnterpriseCustomItemAnimator();
    ...
    public static class FlyItem implements Serializable {
        ...
        @DrawableRes
        public int bgDrawable = com.aliyun.auibarrage.R.drawable.ilr_bg_fly_normal;
    }
}
